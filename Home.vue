			...
			<div class="cuot-inner-column row row-cols-1 m-0">
				...
				<div class="cuot-porc">
					<div class="row row-cols-1">
						...
						<div class="progress" style="background-color: rgba(255,255,255,0.25); height: 10px;">
							<div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 50%; background-color: rgba(0,0,0)" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
						</div>
					</div>
				</div>
				<!-- Barra 2 -->
				<div class="cuot-porc">
					<div class="row row-cols-1">
						...
						<div class="progress" style="background-color: rgba(255,255,255,0.25); height: 10px;">
							<div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 20%; background-color: rgba(0,0,0)" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
						</div>
					</div>
				</div>
				<!-- Barra 3 -->
				...
				<div class="cuot-porc">
					<div class="row row-cols-1">
						...
						<div class="progress" style="background-color: rgba(255,255,255,0.25); height: 10px;">
							<div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 10%; background-color: rgba(0,0,0)" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
						</div>
					</div>
				</div>
			</div>

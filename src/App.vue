<template>
  <div id="app">
    ...
    <div class="d-flex justify-content-center align-content-center w-100 p-3" style="position: absolute; z-index:2; background-color: rgba(255, 255, 255, 0.85); height: 120px; overflow: hidden;">
      <div style="width: 25vw; display: flex; flex-direction: row; align-items: center; justify-content: flex-end">
        <div class="v-social-leftbox" style="display:flex; flex-direction: column;">
      ...
      <div class="d-flex flex-row justify-content-center align-items-center" style="width:50vw;">
      ...
      <div class="v-social-rightbox" style="width: 25vw">
          <div class="v-social-right-container" style="flex-direction:column; justify-content: flex-start; align-items: flex-start">
            <p style="width: 50%; margin: 0; text-align: center; ">Síguenos en </p>

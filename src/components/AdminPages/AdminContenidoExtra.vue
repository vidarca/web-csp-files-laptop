<template>
  <div id="admin-ext-cont" class="position-relative" v-if="show">
    ...
    <section class="translate" v-show="showPrev" v-if="dbWeb.Comites !== undefined && selectComite !== ''" ref="section1">
...
export default {
    ...
    created(){
      this.changeSecTitle('Contenido extra');
    },
